...
const blogPosts = [
  {
    ...
    titleZh: '手机去水印App完整教程：iOS和Android最佳选择',
    titleEn: 'Mobile Watermark Removal Apps: Best Choices for iOS & Android',
    descZh: '详细评测iOS和Android平台最好用的去水印App，包括免费和付费选项，附使用教程。',
    descEn: 'Comprehensive review of the best watermark removal apps for iOS and Android with tutorials.',
    date: '2025-01-20',
    categoryZh: '教程',
    categoryEn: 'Tutorial',
  },
  {
    slug: 'remove-pdf-watermarks',
    titleZh: '如何去除PDF文档水印？5种方法详解',
    titleEn: 'How to Remove PDF Watermarks? 5 Methods Explained',
    descZh: '详细教程：使用Adobe Acrobat、在线工具、转换法等多种方法去除PDF文档水印。',
    descEn: 'Complete tutorial on removing PDF watermarks using Adobe Acrobat, online tools, and conversion methods.',
    date: '2025-01-19',
    categoryZh: '教程',
    categoryEn: 'Tutorial',
  },
  {
    slug: 'remove-instagram-watermarks',
    titleZh: '如何去除Instagram图片水印？完整教程',
    titleEn: 'How to Remove Instagram Watermarks? Complete Guide',
    descZh: '详细教程：去除Instagram照片、Reels、Story水印的多种方法，包括在线工具和手机App。',
    descEn: 'Complete tutorial on removing Instagram photo, Reels, and Story watermarks using online tools and mobile apps.',
    date: '2025-01-18',
    categoryZh: '教程',
    categoryEn: 'Tutorial',
  },
  {
    ...
    titleZh: '如何去除视频水印？完整指南2025',
    titleEn: 'How to Remove Video Watermarks? Complete Guide 2025',
    descZh: '详细教程：使用专业软件、在线工具和AI技术去除视频水印，包括抖音、YouTube等平台视频。',
    descEn: 'Comprehensive tutorial on removing video watermarks using professional software, online tools, and AI technology.',
    date: '2025-01-17',
    categoryZh: '教程',
    categoryEn: 'Tutorial',
  },
  {
    ...
    titleZh: '批量去除图片水印的最佳方法',
    titleEn: 'Best Methods for Batch Watermark Removal',
    descZh: '教你如何高效批量去除多张图片水印，包括在线工具、软件和自动化脚本方案。',
    descEn: 'Learn how to efficiently remove watermarks from multiple images using online tools, software, and automation scripts.',
    date: '2025-01-16',
    categoryZh: '教程',
    categoryEn: 'Tutorial',
  },
  {
    ...
    titleZh: 'Photoshop vs AI去水印工具：哪个更好？',
    titleEn: 'Photoshop vs AI Watermark Remover: Which is Better?',
    descZh: '详细对比Photoshop和AI去水印工具的优缺点、使用难度、效果质量和成本。',
    descEn: 'Detailed comparison of Photoshop and AI watermark removal tools covering pros, cons, difficulty, quality, and cost.',
    date: '2025-01-15',
    categoryZh: '对比评测',
